...
<div class="md:flex-row flex items-center flex-col mx-4 md:mx-0 md:mt-2">
	<div class="w-full md:w-36 z-50 md:m-4 my-2 md:my-0">
		<div class="relative">
			<button
	...
	<nav class="z-50 relative w-full md:w-auto">
		<ul class="flex items-center bg-white border border-gray-300 px-4 space-x-2 py-2">
			<li>
				<a href="/" class="underline">SmartLockers</a>
			</li>
			<li>
				<a href="https://fttx.gr" class="hover:underline flex items-center"
					>FTTx.gr <svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
			...
			<li>
				<a href="https://bus.roberto.gr" class="hover:underline flex items-center"
					>Athens Bus Lines <svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
						stroke-width="1.5"
